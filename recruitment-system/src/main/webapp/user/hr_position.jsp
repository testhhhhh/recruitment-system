...
<!--header area end-->
        ...
        <div class="my_account_area">
            <div class="container">
                ...
                <div class="row">
                    <form action="${pageContext.request.contextPath}/position/insert.do">
                        <div class="col-md-6">
                            <div class="all_cntnt">
                                <div class="frm_content">
                                </div>
                                <div class="al_form-fields">
                                    <input name="hr.hr_id" type="hidden" value="${user.login_id}">
                                    <p>
                                        <label>
                                            岗位名称
                                    ...
                                    <p>
                                        ...
                                        <input name="work_requirement" value="">
                                    </p>
                                    <p>
                                        <label>
                                            工作经验
                                        ...
                                        <input name="work_experience" value="">
                                    </p>
                                    <p>
                                        <label>
                                            学历要求
                                        ...
                                        <input name="education_requirement" value="">
                                    </p>
                                    <p>
                                        <label>
                                            薪水
                                        ...
                                        <input name="salary_requirement" value="">
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="all_cntnt">
                                ...
                                <div class="al_form-fields">
                                    ...
                                    <c:forEach  items="${categorys }" var="categoryMapf" varStatus="status">
                                        <c:if test="${categoryMapf.value.level==2}">
                                            <option value="${categoryMapf.value.id}">${categoryMapf.value.name}</option>
                                        </c:if>
                                    </c:forEach>
                                        </select>
                                    </p>
                                    <p>
                                        ...
                                        <select name="city.id">
                                            <option value="0">不限</option>
                                            <c:forEach  items="${citys }" var="cityMapf" varStatus="status">
                                                <c:if test="${cityMapf.value.level==2}">
                                                    <option value="${cityMapf.value.id}">${cityMapf.value.name}</option>
                                                </c:if>
                                            </c:forEach>
                                        </select>
                                    </p>
                                ...
                                <div class="form-action">
                                    <div class="new_act new_act_3">
                                        ...
                                        <input class="button_act button_act_3" type="submit" value="发布招聘">
                                    </div>
                                </div>
                            </div>
                        </div>
