...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <a  target="mainFrame"  class="">新增分类</a>
    <c:if test="${msg =='success' }"><font -size="4px"; color=blue>&nbsp;&nbsp;&nbsp;<b>添加成功</b></font></c:if>
    <c:if test="${msg =='fail' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>添加失败，请重新尝试</b></font></c:if>
    <c:if test="${msg =='exist' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>已存在</b></font></c:if>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="${pageContext.request.contextPath}/category/add.do">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <input type="hidden" name="id" value="0" class="text-word">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="father_id" value="" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">等级：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
          <input type="text" name="level" value="" class="text-word">
        </td>
      </tr>
