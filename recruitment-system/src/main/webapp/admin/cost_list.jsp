...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：财务管理&nbsp;&nbsp;>&nbsp;&nbsp;财务报表</td>
  </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         ...
	         <input type="hidden" name="search" value="cost"/>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">成员</th>
        <th align="center" valign="middle" class="borderright">费用</th>
        <th align="center" valign="middle" class="borderright">所属社团</th>

<%--        <th align="center" valign="middle">操作</th>--%>
      </tr>
      <c:forEach items="${costs }" var="co" varStatus="status">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="center" valign="middle" class="borderright borderbottom">${status.index+1 }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${co.costId}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${co.activityId}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${co.activityName}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${co.loginName}</td>
		<td align="center" valign="middle" class="borderright borderbottom">${co.memberName}</td>
        <td align="center" valign="middle" class="borderright borderbottom">${co.money }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${co.communityName}</td>
        ...
        &nbsp; &nbsp; &nbsp;
         <c:choose>
         	<c:when test="${page.pageCurrent==1 }">
         		<a href="Query?lru=costlist&cpage=${page.pageCurrent }">首页</a>
         		<a href="Query?lru=costlist&cpage=${page.pageCurrent }">上一页</a>
         	</c:when>
         	<c:otherwise>
		         <a href="Query?lru=costlist&cpage=1">首页</a>
         	 	<a href="Query?lru=costlist&cpage=${page.pageCurrent-1}">上一页</a>
         	</c:otherwise>
         </c:choose>   

           <c:choose>
         	<c:when test="${page.pageCurrent==page.pageCont }">
         		<a href="Query?lru=costlist&cpage=${page.pageCurrent }">下一页</a>
         		<a href="Query?lru=costlist&cpage=${page.pageCurrent }">尾页</a>
         	</c:when>
         	<c:otherwise>
		         <a href="Query?lru=costlist&cpage=${page.pageCurrent+1}">下一页</a>
          	     <a href="Query?lru=costlist&cpage=${page.pageCont}">尾页</a></c:otherwise>
         </c:choose></tr></tr>
</table>
</body>
</html>