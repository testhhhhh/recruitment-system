...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：资讯管理&nbsp;&nbsp;>&nbsp;&nbsp;资讯信息</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
      <a  target="mainFrame"  class="">编辑资讯</a>
      <c:if test="${param.rs =='namewrong' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>没有此资讯，请先添加</b></font></c:if>
      <c:if test="${param.rs =='success' }"><font -size="4px"; color=blue>&nbsp;&nbsp;&nbsp;<b>更新成功</b></font></c:if>
      <c:if test="${param.rs =='fail' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>更新失败，请重新尝试</b></font></c:if>
      <c:if test="${param.rs =='wrong' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>错误</b></font></c:if>
  ...
  <tr>
    <td align="left" valign="top">
      <!-- 上传文件时 要改enctype="multipart/from-data-->
      <form action="${pageContext.request.contextPath}/notice/update.do" method="post" <%--enctype="multipart/form-data"--%>>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
          ...
          <tr>
            <td align="right" valign="middle" class="borderright borderbottom bggray">资讯id：</td>
            <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
              <input type="text" readonly="true" name="notice_id" value="${notice.notice_id }" class="text-word">

            <td align="right" valign="middle" class="borderright borderbottom bggray">资讯标题：</td>
            <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
              <input type="text" name="title" value="${notice.title }" class="text-word">
            </td>
          </tr>
...
<%--                <input type="text"  name="noticeIntroduction" value="${notice.noticeIntroduction}" class="text-word" type="hidden">--%>
            ...
            <tr>
              <td align="right" valign="middle" class="borderright borderbottom bggray">资讯时间：</td>
              <td align="left" valign="middle" class="borderright borderbottom main-for" onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
                <input type="text"  readonly="true" name="release_time" value="${notice.release_time }" class="text-word">
            </tr>
          <tr>
            <td align="center" valign="middle" class="borderright borderbottom main-for" colspan="2" style="padding-left:38%; border-right:none;">
              <input name="" type="submit" value="更新" class="text-but" >
