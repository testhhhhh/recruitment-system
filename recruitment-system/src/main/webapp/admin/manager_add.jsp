...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：账户管理&nbsp;&nbsp;>&nbsp;&nbsp;添加账户</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a  target="mainFrame"  class="">新增账户</a>
    ...
    <c:if test="${msg =='exist' }"><font -size="4px"; color=red>&nbsp;&nbsp;&nbsp;<b>手机号已存在</b></font></c:if>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="${pageContext.request.contextPath}/users/register.do?c=a">
