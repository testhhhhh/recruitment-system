...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：公司管理&nbsp;&nbsp;>&nbsp;&nbsp;公司列表</td>
  </tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         <form method="post" action="${pageContext.request.contextPath}/company/someForSearch.do">
	         <span>公司名：</span>
...
<%--            <span class="gray">&nbsp;|&nbsp;</span>--%>
          <td align="center" valign="middle" class="borderright borderbottom">
            <form id="del${status.index}" method="post" action="${pageContext.request.contextPath}/company/delete.do">
